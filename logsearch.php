...
if (isset($_POST['submit'])) {
    $findservice = $_POST['findservice'];
    $sarea = $_POST['searcharea'];
    $scity = $_POST['searchcity'];
    $sql = "SELECT * from posts WHERE lookingfor='$findservice' AND city='$scity' AND approve_id=1";
    ...
    <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                ...
                "@type": "WebPage",
                "@id": "https://echobuyer.com/search-services/#webpage",
                "url": "https://echobuyer.com/search-services/",
                "name": "Search Services | Group Buying service| Echobuyer",
                "isPartOf": {
                    "@id": "https://echobuyer.com/#website"
                },
                "datePublished": "2021-02-23T20:11:31+00:00",
                "dateModified": "2022-05-09T15:39:57+00:00",
                "description": "Looking to save money on your next purchase? Check out echobuyer.com! This site lets you buy items together with other people in your area, making it a great way to get deals on stuff you wouldn't be able to find alone. Just enter the product you want to buy and how many people you want to buy it with, and echobuyer will take care of the rest.",
                "breadcrumb": {
                    "@id": "https://echobuyer.com/search-services/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["https://echobuyer.com/search-services/"]
                }]
            }, {
                "@type": "BreadcrumbList",
                "@id": "https://echobuyer.com/search-services/#breadcrumb",
            ...
            <section id="page" class="page imap userprofile">
                <div class="container px-0 px-lg-3" data-aos="fade-up">
                    <div class="section-title">
                        ...
                        <br />
                        <h4 class="text-center">If not, post a listing on the <a href="logindex.php" class="text-primary">Post page</a> so nearby consumers will join you.</h4>
                    </div>
                            ...
                            <ul>
                                ...
                                ?>
                                        <li class="yu-only-desktop row">
                                            <!-- <div class="lookingfor"><label>Post Number</label></div> -->
                                            <div class="lookingfor post_number col-md-2">
                                        <a class=" font-weight-bold"><?php echo $row['post_id']; ?></a>

                                    </div>
                                    <div class="col-md-10">
                                        <div class="lookingfor title">
                                            <a href="post_details.php?postid=<?php echo $pd; ?>" class="font-weight-bold"><?php echo $row['lookingfor']; ?></a>
                                        </div>
                                        <div class="lookingfor discount">
                                            <a  class="font-weight-bold"><?php echo $row['username']; ?></a>
                                        </div>
                                        <div class="lookingfor">
                                            <a  class="font-weight-bold"><?php echo $row['city']; ?></a>
                                        </div>
                                        <div class="lookingfor">
                                            <a  class="font-weight-bold"><?php echo $row['price']; ?></a>
                                        </div>
                                        <div class="lookingfor action">
                                            
                                        <input type="checkbox"  onclick="themeToggle()" id="theme-switcher" >
                                           <!-- <label class="mb-0"><button id="h">♡</button></label>-->
                                                <!--<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
</svg>-->
                                        </div>
                                        <div class="lookingfor action">
                                        <a href="../chat/login.php"><label class="mb-0">Message</label></a>
                                        </div>
                                    </div>
                                            <hr />
                                            <hr />
                                ...
                                <?php } else {
                                    ...
                                    echo ("<li><strong>No data

                                            found
                                            .Try posting your requirement.</strong></li>");
                                } ?>
  ...
  $(this).toggleClass("fa-heart fa-heart-o");
    ...
    <script id='ihs_otp_main_js-js-extra'>
        var otp_obj = {
            ...
            "ajax_nonce": "a60371724a",
            "form_selector": ".page-id-48-disabled .tml-register-disabled",
            "submit_btn_selector": ".page-id-48-disabled .tml-button-disabled",
            "input_required": "",
            "mobile_input_name": "user_phone-disabled",
            "ihs_country_code": "91",
            "ihs_mobile_length": "10",
            "wpml_messages": {
                "mobile_box_label": "Mobile Number with Country Code (required)",
                "otp_required": "OTP( required )",
                "send_otp": "Send OTP",
                "otp_verify_label": "Enter Verification Code sent",
                "verify_otp": "Verify OTP",
                "resend_otp": "Resend OTP",
                "reset_pwd_via_otp": "Reset Password via OTP",
                ...
                "alerts": {
                    "pls_verify_otp_first": "Please verify OTP first",
                    "pls_enter_req_field": "Please Enter the required fields",
                    "pls_enter_otp": "Please Enter OTP",
                    "thx_for_verification": "Thank you for verification",
                    "otp_enter_incorrect": "OTP Entered is Incorrect",
                    "tried_too_many_times": "You have tried too many times",
                    "otp_sent_to_mobile": "OTP sent to your mobile",
                    "enter_mobile_no": "Enter the mobile number",
                    "enter_crt_mobile_no": "Enter the correct Mobile Number",
                    ...
                    "sending_new_pass": "Sending new password...",
                    "new_pass_sent": "New password sent to your mobile"
                }
            }
        };
    </script>

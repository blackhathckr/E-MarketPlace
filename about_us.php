...
if (isset($_POST['sub'])) {
	...
	if (empty($name) or empty($email) or empty($phone)  or empty($message)) {
		...
		$stmt = $con->prepare("INSERT INTO aboutus(name,email,phone,message) VALUES (?,?,?,?)");
		$stmt->bind_param("ssis", $name, $email, $phone, $message);
		$stmt->execute();
		$stmt->close();
		$conn->close();
		/*$sql = "INSERT INTO aboutus(name,email,phone,message) VALUES ('$name','$email','$phone','$message')";
...
<head>
	...
	<title>About us - Echo Buyer</title>
	<link rel="canonical" href="https://echobuyer.com/about-us/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="About us - Echo Buyer" />
	<meta property="og:description" content="EchoBuyer removes the marketing power of the vendor and puts the purchasing power in the hands of the consumers. Echobuyer matches consumers who want to purchase the same product or service and groups them in such a way that the collective receives a discount. By promising the business guaranteed customers, they are willing to reduce&hellip; Continue reading About us" />
	<meta property="og:url" content="https://echobuyer.com/about-us/" />
	<meta property="og:site_name" content="Echo Buyer" />
	<meta property="article:modified_time" content="2021-08-31T17:59:54+00:00" />
	...
	<script type="application/ld+json" class="yoast-schema-graph">
		{
			...
			"@graph": [{
				...
				"@type": "WebPage",
				"@id": "https://echobuyer.com/about-us/#webpage",
				"url": "https://echobuyer.com/about-us/",
				"name": "About us - Echo Buyer",
				"isPartOf": {
					"@id": "https://echobuyer.com/#website"
				},
				"datePublished": "2021-08-31T17:49:36+00:00",
				"dateModified": "2021-08-31T17:59:54+00:00",
				"breadcrumb": {
					"@id": "https://echobuyer.com/about-us/#breadcrumb"
				},
				"inLanguage": "en-US",
				"potentialAction": [{
					"@type": "ReadAction",
					"target": ["https://echobuyer.com/about-us/"]
				}]
			}, {
				"@type": "BreadcrumbList",
				"@id": "https://echobuyer.com/about-us/#breadcrumb",
	...
	<script id='ajax-script-js-extra'>
		var ajax_object = {
			"ajax_url": "https:\/\/echobuyer.com\/wp-admin\/admin-ajax.php"
		};
	</script>
...
<body class="page-template page-template-templates page-template-template-about page-template-templatestemplate-about-php page page-id-111 wp-embed-responsive is-light-theme no-js singular elementor-default elementor-kit-205">
								...
								<div class="limit-box">
									<nav class="main-menu mmenu-hide" id="menu">
										...
										<ul class="menu-area-main">
											...
											<!--<li><a href="https://echobuyer.com/login">Login</a></li> -->
				...
				<div class="container">
					...
					<article id="post-111" class="post-111 page type-page status-publish hentry entry">
						...
						<div class="entry-content">
							...
							<p>EchoBuyer removes the marketing power of the vendor and puts the purchasing power in the
								hands of the consumers. Echobuyer matches consumers who want to purchase the same
								product or service and groups them in such a way that the collective receives a
								discount. By promising the business guaranteed customers, they are willing to reduce the
								group price overall.<br />
								By reducing business’s need for marketing costs, they are willing to sacrifice their
								full retail price for our EchoBuyer users.</p>
						...
						<div class="col-md-12">
							...
							<div role="form" class="wpcf7" id="wpcf7-f11-o1" lang="en-US" dir="ltr">
								...
								<form action="" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
									...
									<div class="form-group"><span class="wpcf7-form-control-wrap yourname"><input type="text" name="name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control" aria-required="true" aria-invalid="false" placeholder="Name" /></span>
									</div>
									<div class="form-group"><span class="wpcf7-form-control-wrap email"><input type="text" name="email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control" aria-required="true" aria-invalid="false" placeholder="Email" /></span>
									</div>
									<div class="form-group"><span class="wpcf7-form-control-wrap phone"><input type="text" name="phone" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control" aria-required="true" aria-invalid="false" placeholder="Phone" /></span>
									</div>
									...
									<div class="submit_btn"><input type="submit" value="Send" name="sub" class="wpcf7-form-control has-spinner wpcf7-submit btn btn-primary" /></div>

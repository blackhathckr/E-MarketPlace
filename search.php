...
?>
    <script>
        ...
        function getLatLon(position) {
            ...
            $sql2 = "INSERT INTO guest(ip,service,area,latitude,longitude) VALUES ('$ip','$findservice','$sarea','$latitude','$longitude')";
...
<body class="page-template page-template-templates page-template-template-search-services page-template-templatestemplate-search-services-php page page-id-25 wp-embed-responsive is-light-theme no-js singular elementor-default elementor-kit-205">
                    ...
                    <div class="form_section searchForm">
                        <form method="post" action="search.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-2" style="visibility: hidden;">
                                <label>Area</label>
                                <br />
                                <input type="text" class="form-control" autocomplete="off" id="area" name="searcharea" value="" placeholder="">
                            </div>
  ...
  function getLatLon(position) {
    var latitude = position.coords.latitude;
    var longitude = position.coords.longitude;
    //window.location.href = "cord.php?lat=" + latitude + "&long=" + longitude + "&username=<?php echo $username; ?>";
  }
  </script>
                           <a href="guest.php" onclick="location.href=this.href+'?latitude='+latitude+'?longitude='+longitude+'?ip='<?php echo $ip; ?>";    style="background-color:#37517e;">Back </a>
                            ...
                            <ul>
                                <li class="yu-only-desktop row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="lookingfor discount">
                                            <a class=" font-weight-bold">Street</a>
                                        </div>
                                ...
                                ?>
                                        <li class="yu-only-desktop row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="lookingfor title">
                                                    <a  class="font-weight-bold"><?php echo $row['lookingfor']; ?></a>
                                                </div>
                                                <div class="lookingfor discount">
                                                    <a class="font-weight-bold"><?php echo $row['street']; ?></a>
                                                </div>
                                                <div class="lookingfor">

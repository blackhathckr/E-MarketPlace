        ...
        <div class="col-md-8">
            <div class="card-hover-shadow-2x mb-3 card">
                <div class="card-header-tab card-header">
                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="fa fa-tasks"></i>&nbsp;<span class="pending">Users Info</span></div>
                                            ...
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left mr-2">
                                                    <div class="custom-checkbox custom-control">
                                                        <h6><?php echo $res['user_id']; echo ".";?>&nbsp;</h6>
                                                ...
                                                <div class="widget-content-left">
                                                    <div class="widget-heading" style="font-size:20px;color:black;font-weight:bold;"><?php echo $res['username'];?><!--<div class="badge badge-danger ml-2">Pending</div>-->
                                                    </div>
                                                    <div id="i" class="widget-subheading" style="font-size:13px;"><i ><span >First Name : <?php echo $res['fname'];?>  &nbsp;&nbsp;&nbsp;&nbsp;
                                                    Last Name : <?php echo $res['lname'];?>  &nbsp;&nbsp;&nbsp;&nbsp;
                                                    Email : <?php echo $res['email'];?> &nbsp;&nbsp;&nbsp;&nbsp;
                                                     Phone : <?php echo $res['phone'];?> &nbsp;&nbsp;&nbsp;&nbsp;
                                                     <br /> Area : <?php echo $res['area'];?>  &nbsp;&nbsp;&nbsp;&nbsp;
                                                     City : <?php echo $res['city'];?> &nbsp;&nbsp;&nbsp;&nbsp;
                                                    Country : <?php echo $res['country'];?> &nbsp;&nbsp;&nbsp;&nbsp;
                                                    Zipcode : <?php echo $res['zipcode'];?> </span> </i></div>
                                                ...
                                                <!--<a href="ban.php?username= ?>"><button class="border-0 btn-transition btn btn-outline-success">
                                                     ...
                                                     <a href="ban.php?username=<?php echo $res['username']; ?>">  <button class="border-0 btn-transition btn btn-outline-danger">

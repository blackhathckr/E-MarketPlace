        ...
        <div class="col-md-8">
            <div class="card-hover-shadow-2x mb-3 card">
                <div class="card-header-tab card-header">
                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="fa fa-tasks"></i>&nbsp;<span class="pending">Guests</span></div>
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    <div class="widget-heading" style="font-size:20px;color:black;font-weight:bold;">Service Searched for : <?php echo $res['service'];?><!--<div class="badge badge-danger ml-2">Pending</div>-->
                                                    </div>
                                                    <div id="i" class="widget-subheading" style="font-size:13px;"><i ><span >IP -  <?php echo $res['ip'];?>  &nbsp;&nbsp;&nbsp;&nbsp;
                                                ...
                                                <!--<a href="ban.php?username= ?>"><button class="border-0 btn-transition btn btn-outline-success">
                                                     ...
                                                     <a href="ban.php?username= <button class="border-0 btn-transition btn btn-outline-danger">
